                    ...
                    if (result != null) {
                        when (result){
                            ...
                            is Result.Success -> {
                                ...
                                placeAdapter(place)
//                                val placeAdapter = PlaceAdapter (object : PlaceAdapter.OnItemClickCallBack {
//                                    override fun onItemClicked(data: MuseumDataItem) {
//                                        val storyIntent = Intent(this@MainActivity, RewardActivity::class.java)
//                                        storyIntent.putExtra(RewardActivity.ID, data.id)
//                                        startActivity(storyIntent)
//                                    }
//                                })
//                                placeAdapter.submitList(place)
